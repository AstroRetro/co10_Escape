...
A3E_VAR_Side_Blufor = west;	//player side SOGPF ANZAC
A3E_VAR_Side_Opfor = east; //SOGPF PAVN VPN Marines
...
a3e_arr_extraction_chopper = [
	"vn_b_air_uh1d_01_06"	//UH-1D Iroquois Dust-off (RAAF)
	,"vn_b_air_uh1d_02_06"	//UH-1D Iroquois Slick (RAAF)
	,"vn_b_air_uh1b_01_06"	//UH-1B Iroquois Dust-off (RAAF)
	,"vn_b_air_uh1c_07_06"	//UH-1B Iroquois Slick (RAAF)
	,"vn_b_air_uh1d_04_09"	//UH-1D Iroquois (CIA)
	];
a3e_arr_extraction_chopper_escort = [
	"vn_b_air_uh1c_01_06"   //UH-1C Iroquois Hog (RAAF)
	,"vn_b_air_uh1c_02_06"  //UH-1C Iroquois Gunship (RAAF)
	,"vn_b_air_uh1c_04_06"  //UH-1C Iroquois Frog (RAAF)
	,"vn_b_air_uh1c_05_06"  //UH-1C Iroquois Heavy Hog (RAAF)
	,"vn_b_air_uh1d_03_06"  //UH-1D Iroquois Bushranger (RAAF)  
	,"vn_b_air_uh1c_01_06"  //UH-1C Iroquois Hog (RAAF)  
	];
...
a3e_arr_extraction_boat = [
	"vn_b_boat_12_02"	//PTF Nasty Boat (40mm, Black)	4cargo seats (MACV)
	,"vn_b_boat_06_02"	//PTF Nasty Boat (40mm, Black) (MACV)
	,"vn_b_boat_06_01"	//PTF Nasty Boat (40mm, Red) (MACV)
	,"vn_b_boat_05_02"	//PTF Nasty Boat (Mortar/ Black) (MACV)
	,"vn_b_boat_05_01"	//PTF Nasty Boat (Mortar/ Red) (MACV)
	,"vn_b_boat_09_01"  //STAB (M60) 6 cargo seats (MACV)
	];
a3e_arr_extraction_boat_escort = [
	"vn_b_boat_12_03"	//PBR MkII (M60, Red, Dirty) (MACV)
	,"vn_b_boat_12_04"  //PBR MkII (M60, Black, Dirty) (MACV)
	,"vn_b_boat_12_01"  //PBR MkII (M60, Red, Clean) (MACV)
	,"vn_b_boat_12_03"  //PBR MkII (M60, Red, Dirty) (MACV)
	,"vn_b_boat_13_02"  //PBR MkII (Mk18, Black, Clean) (MACV)
	,"vn_b_boat_13_04"  //PBR MkII (Mk18, Black, Dirty) (MACV)
	,"vn_b_boat_13_01"  //PBR MkII (Mk18, Red, Clean) (MACV)
	,"vn_b_boat_13_03"  //PBR MkII (Mk18, Red, Dirty) (MACV)
	,"vn_b_boat_10_01"	//STAB (M2) (MACV)
	,"vn_b_boat_11_01"	//STAB (Mk18) (MACV)
	,"vn_b_boat_06_02"	//PTF Nasty Boat (40mm, Black) (MACV)
	,"vn_b_boat_06_01"  //PTF Nasty Boat (40mm, Red) (MACV)
	,"vn_b_boat_05_02"  //PTF Nasty Boat (Mortar/ Black) (MACV)
	,"vn_b_boat_05_01"  //PTF Nasty Boat (Mortar/ Red) (MACV)
...
//////////////////////////////////////////////////////////////////
a3e_arr_searchdrone = [
	"vn_o_air_mi2_01_01"  //Mi-2P Hoplite (Transport) (PAVN)
	,"vn_o_air_mi2_01_02"];  //Mi-2P Hoplite (Transport/ metal) (PAVN)
...
a3e_arr_searchChopperHard = [
	"vn_o_air_mi2_03_06"  //Mi-2US Hoplite (FAC/ camo) (PAVN)
	,"vn_o_air_mi2_03_03"];  //Mi-2US Hoplite (MG) (PAVN)
a3e_arr_searchChopper_pilot = [
	"vn_o_men_aircrew_01"  //Heli Pilot (PM) (PAVN)
	,"vn_o_men_aircrew_02"];  //Heli Co-Pilot (TT-33) (PAVN)
a3e_arr_searchChopper_crew = [
	"vn_o_men_aircrew_03"  //Heli Crew Chief (PM) (PAVN)
	,"vn_o_men_aircrew_04"];  //Heli Gunner (TT-33) (PAVN)
...
//////////////////////////////////////////////////////////////////
a3e_arr_CASplane = [
	"vn_o_air_mig19_cas"  //MiG-19 S (CAS) (PAVN)
	,"vn_o_air_mig19_mr"];	//MiG-19 S (MR) (PAVN)
...
A3E_Trap_Classes = [["random","vn_mine_punji_03"],["random","vn_mine_punji_01"],["random","vn_mine_punji_02"],["random","vn_mine_m14"]];//,["roadcenter","vn_mine_tripwire_m16_04"],["roadcenter","vn_mine_tripwire_arty"],["roadside","vn_mine_tripwire_f1_02"]]; Classnames of traps and mines. String or array in form [classname, trigger range, scriptcode]
